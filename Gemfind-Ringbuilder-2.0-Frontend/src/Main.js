...
const Main = () => {
  ...
  if (skeltonLoad === true) {
    ...
    return (
      <Routes basename={"/engagement-rings"}>
        <Route
        ...
        ></Route>
        <Route
          path={`${process.env.PUBLIC_URL}/completering`}
    ...
    return (
      <>
        <div className="gf-rb-tool-container">
          <Skeleton height={80} />
          <Skeleton />
          <div className="gf-rb-Skeleton-type">
            <Skeleton count={9} height={60} />
          </div>
          <div className="gf-rb-Skeleton-settings">
            <div className="gf-rb-skeleton-div">
              <div className="gf-rb-skelton-info">
              
                <div className="gf-rb-div-right">
                  {" "}
            ...
            <div className="gf-rb-skeleton-div">
              <div className="gf-rb-skelton-info">
                ...
                <div className="gf-rb-div-right-price">
                  <Skeleton height={60} />
                </div>
                <div className="gf-rb-div-right-metal">
                  <Skeleton height={60} />
                </div>
              </div>
            </div>
          </div>
          <div className="gf-rb-s_gridview">
            <div className="gf-rb-Skeleton__lists">
