...
const DiamondtoolSetting = (props) => {
    ...
    const [getDiamondCompareArrayCookie, setDiamondCompareArrayCookie] =
        useState([]);
    ...
    const clarityName = (clarityName) => {
        ...
        var res = getDiamondClarity.filter(function (v) {
            return (
                v.clarityId >= parseInt(startColor) &&
                v.clarityId <= parseInt(endColor)
            );
        });
    ...
    const getInitFilterDiamondData = async (DealerID, tabname) => {
        try {
            if (tabname === "fancycolor") {
                var url =
                    `${window.initData.data[0].filterapifancy}DealerID=` +
                    DealerID;
            } else {
                var url =
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        {getcomparecookie.finalcompareproductcookie.map(
                                            (item) => (
                                                <th
                                                    key={`product-image-${item.diamondId}`}
                                                >
                                                    <img
                                                        src={
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        {getcomparecookie.finalcompareproductcookie.map(
                                            (item) => (
                                                <td
                                                    key={`product-shape-${item.diamondId}`}
                                                >
                                                    {item.shape
                                                        ? item.shape
                                                        : "NA"}
                                    ...
                                    <tr>
                                        ...
                                        {getcomparecookie.finalcompareproductcookie.map(
                                            (item) => (
                                                <td
                                                    key={`product-carat-${item.diamondId}`}
                                                >
                                                    {item.caratWeight
                                                        ? item.caratWeight
                                                        : "NA"}
                                    ...
                                    <tr>
                                        ...
                                        {getcomparecookie.finalcompareproductcookie.map(
                                            (item) => (
                                                <td
                                                    key={`product-table-${item.diamondId}`}
                                                >
                                                    {item.table
                                                        ? item.table
                                                        : "NA"}
                                    ...
                                    <tr>
                                        ...
                                        {getcomparecookie.finalcompareproductcookie.map(
                                            (item) => (
                                                <td
                                                    key={`product-color-${item.diamondId}`}
                                                >
                                                    {item.color
                                                        ? item.color
                                                        : "NA"}
                                    ...
                                    <tr>
                                        ...
                                        {getcomparecookie.finalcompareproductcookie.map(
                                            (item) => (
                                                <td
                                                    key={`product-polish-${item.diamondId}`}
                                                >
                                                    {item.polish
                                                        ? item.polish
                                                        : "NA"}
                                    ...
                                    <tr>
                                        ...
                                        {getcomparecookie.finalcompareproductcookie.map(
                                            (item) => (
                                                <td
                                                    key={`product-symmetry-${item.diamondId}`}
                                                >
                                                    {item.symmetry
                                                        ? item.symmetry
                                                        : "NA"}
                                    ...
                                    <tr>
                                        ...
                                        {getcomparecookie.finalcompareproductcookie.map(
                                            (item) => (
                                                <td
                                                    key={`product-clarity-${item.diamondId}`}
                                                >
                                                    {item.clarity
                                                        ? item.clarity
                                                        : "NA"}
                                    ...
                                    <tr>
                                        ...
                                        {getcomparecookie.finalcompareproductcookie.map(
                                            (item) => (
                                                <td
                                                    key={`product-fluorescence-${item.diamondId}`}
                                                >
                                                    {item.fluorescence
                                                        ? item.fluorescence
                                                        : "NA"}
                                    ...
                                    <tr>
                                        ...
                                        {getcomparecookie.finalcompareproductcookie.map(
                                            (item) => (
                                                <td
                                                    key={`product-depth-${item.diamondId}`}
                                                >
                                                    {item.depth
                                                        ? item.depth
                                                        : "NA"}
                                    ...
                                    <tr>
                                        ...
                                        {getcomparecookie.finalcompareproductcookie.map(
                                            (item) => (
                                                <td
                                                    key={`product-measurement-${item.diamondId}`}
                                                >
                                                    {item.measurement
                                                        ? item.measurement
                                                        : "NA"}
                                    ...
                                    <tr>
                                        ...
                                        {getcomparecookie.finalcompareproductcookie.map(
                                            (item) => (
                                                <td
                                                    key={`product-certificate-${item.diamondId}`}
                                                >
                                                    {item.certificate
                                                        ? item.certificate
                                                        : "NA"}
                                    ...
                                    <tr>
                                        ...
                                        {getcomparecookie.finalcompareproductcookie.map(
                                            (item) => (
                                                <td
                                                    key={`product-cut-${item.diamondId}`}
                                                >
                                    ...
                                    <tr>
                                        ...
                                        {getcomparecookie.finalcompareproductcookie.map(
                                            (item) => (
                                                <td
                                                    key={`product-price-${item.diamondId}`}
                                                >
                                                    {item.fltPrice ===
                                                    "Call for Price"
                                                        ? ""
