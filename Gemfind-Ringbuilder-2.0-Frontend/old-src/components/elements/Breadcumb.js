    ...
    <>
      <style>
        {`.breadCumbs .active a {
            ...
            // .breadCumbs .breadCumb.active h2{
            // color: ${window.initData["data"][0].link_colour};
            // }
            // .breadCumbs .active a p.subTitle{
            //   color: ${window.initData["data"][0].link_colour};
            // }
            .breadCumbs .active a::before , .breadCumbs .active a::after{
      ...
      >
        <a href="#" id={`${props.Data.urlkey}`} onClick={handlenavigation}>
