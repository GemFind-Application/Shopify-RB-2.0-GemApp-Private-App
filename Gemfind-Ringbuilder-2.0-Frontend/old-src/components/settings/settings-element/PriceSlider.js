...
const PriceSlider = (props) => {
  ...
  const startPriceOnChange = (event) => {
    ...
    if(Number.isInteger(intValue) && intValue >= 0 && intValue <= Number(marks[0].maxPrice)){
    ...
    alert("Please Enter Valid Price Between 0 to "+Number(marks[0].maxPrice));
    return;
  }
  };
      ...
      <div className="range-slider_diamond">
        ...
        <div className="input-value">
          <div className="input-value-left">
            <span className={ window.initData["data"][0].price_row_format === '0' ? "icon-right" : "icon-left"}>
            ...
            <input
              className={ window.initData["data"][0].price_row_format === '0' ? "input-left" : ""}
              type="text"
              value={startPrice}
          ...
          <div className="input-value-right">
            ...
            <input type="text" value={lastPrice} onChange={endValueOnChange} className={ window.initData["data"][0].price_row_format === '0' ? "input-left" : ""} />
          </div>
        </div>
      </div>
    );
