  ...
  const handleAddToCart = async (e) => {
    ...
    const requestOptions = {
      ...
      body: JSON.stringify({
        ...
        setting_id: getsettingcookies._shopify_ringsetting[0].setting_id,
          ...
          >
            <div className="popup_content">
              <p className="popup_pr">
                This refer to different type of Metal Type to filter and select
                the appropriate ring as per your requirements. Look for a metal
                type best suit of your chosen ring.
              </p>
              <div className="diamond-information">
                ...
                <ul>
                  ...
                  <li>
                    ...
                    {props.settingDetailsData.showPrice === true && (
                      <div className="diamonds-info">
                        ...
                        ? (props.settingDetailsData.currencyFrom === 'USD'
                            ? window.currency + Number(props.settingDetailsData.cost).toLocaleString(undefined, {
                              maximumFractionDigits: 0, 
                            })
                            : props.settingDetailsData.currencyFrom + "  " + props.settingDetailsData.currencySymbol + "  " + Number(props.settingDetailsData.cost).toLocaleString(undefined, {
                              maximumFractionDigits: 0, 
                            })
                          )
                        : (props.settingDetailsData.currencyFrom === 'USD'
                            ...
                            : Number(props.settingDetailsData.cost).toLocaleString(undefined, {
                              maximumFractionDigits: 0, 
                            })  + "  " + props.settingDetailsData.currencySymbol + "  " + props.settingDetailsData.currencyFrom
                          )
                      }
                        </p>
                      </div>
                  ...
                  <li>
                    ...
                    <div className="diamonds-info">
                      <p>{props.settingDetailsData.metalType}</p>
                    </div>
                  </li>
                </ul>
                <div className="spacification-info">
              ...
              <div className="diamond-information">
                ...
                <ul className="diamond-spacification-list">
                      ...
                      <p>
                        {props.diamondDetailsData.fltPrice === "Call for Price"
                          ...
                          ? (props.diamondDetailsData.currencyFrom === 'USD'
                              ? window.currency + Number(props.diamondDetailsData.fltPrice).toLocaleString(undefined, {
                                maximumFractionDigits: 0, 
                              })
                              : props.diamondDetailsData.currencyFrom + "  " + props.diamondDetailsData.currencySymbol + "  " + Number(props.diamondDetailsData.fltPrice).toLocaleString(undefined, {
                                maximumFractionDigits: 0, 
                              })
                            )
                          : (props.diamondDetailsData.currencyFrom === 'USD'
                              ...
                              : Number(props.diamondDetailsData.fltPrice).toLocaleString(undefined, {
                                maximumFractionDigits: 0, 
                              })  + "  " + props.diamondDetailsData.currencySymbol + "  " + props.diamondDetailsData.currencyFrom
                            )}
                          {
                      }
                        {/* {props.diamondDetailsData.fltPrice === "Call for Price"
                  ...
                  <li>
                    ...
                    <div className="diamonds-info">
                      <p>
                        {props.diamondDetailsData.caratWeight
                          ? props.diamondDetailsData.caratWeight
                          : "-"}
                      </p>
                    </div>
                  ...
                  <li>
                    ...
                    <div className="diamonds-info">
                      <p>
                        {props.diamondDetailsData.symmetry
                          ? props.diamondDetailsData.symmetry
                          : "-"}
                      </p>
                    </div>
                  ...
                  <li>
                    ...
                    <div className="diamonds-info">
                      <p>
                        {props.diamondDetailsData.girdleThick
                          ? props.diamondDetailsData.girdleThick
                          : "-"}
                      </p>
                    </div>
                  ...
                  <li>
                    ...
                    <div className="diamonds-info">
                      <p>
                        {props.diamondDetailsData.fluorescence
                          ? props.diamondDetailsData.fluorescence
                          : "-"}
                      </p>
                    </div>
                  ...
                  <li>
                    ...
                    <div className="diamonds-info">
                      <p>
                        {props.diamondDetailsData.measurement
                          ? props.diamondDetailsData.measurement
                          : "-"}
                      </p>
                    </div>
