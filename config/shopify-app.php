...
return [
    ...
    */
    ...
    'api_key' => env('SHOPIFY_API_KEY', '2d3e0044ab584108969f219d0600d6e9'),
    ...
    */
    ...
    'api_secret' => env('SHOPIFY_API_SECRET', 'ed4aefbbb7bec4f811219bc2753d4cce'),
    ...
    */
    ...
    'api_scopes' => env('SHOPIFY_API_SCOPES', 'read_inventory,write_inventory,read_products,read_themes,write_themes,
        write_products,write_script_tags'),
    /*
    |--------------------------------------------------------------------------
    ...
    */
    ...
    'scripttags' => [
        [
            'src' => env('SHOPIFY_SCRIPTTAG_1_SRC', 'https://gemapps.app.theringbuilder.com/widgets/static/js/bundle.js'),
            'event' => env('SHOPIFY_SCRIPTTAG_1_EVENT', 'onload'),
            'display_scope' => env('SHOPIFY_SCRIPTTAG_1_DISPLAY_SCOPE', 'online_store')
        ],
        [
            'src' => env('SHOPIFY_SCRIPTTAG_2_SRC', 'https://gemapps.app.theringbuilder.com/customCssFront/customFrontCss.js'),
