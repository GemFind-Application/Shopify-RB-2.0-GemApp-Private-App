          ...
          <tbody>
            {props.listviewData.map((item) => (
              ...
              >
                ...
                <td className="Sizecol"> {item.carat ? item.carat : "-"} </td>
                <td className="Colorcol"> {item.color ? item.color : "-"} </td>
                {props.tabname !== "" && (
                ...
                <td className="CutGradecol"> {functionWithSwitch(item.cut)}</td>
                <td className="Depthcol"> {item.depth ? item.depth : "-"} </td>
                ...
                <td className="FltPricecol">
                  {item.fltPrice === "Call for Price"
                          ...
                          ? (item.currencyFrom === 'USD'
                              ? window.currency + Number(item.fltPrice).toLocaleString(undefined, {
                                maximumFractionDigits: 0, 
                              })
                              : item.currencyFrom + "  " + item.currencySymbol + "  " + Number(item.fltPrice).toLocaleString(undefined, {
                                maximumFractionDigits: 0, 
                              })
                            )
                          : (item.currencyFrom === 'USD'
                              ...
                              : Number(item.fltPrice).toLocaleString(undefined, {
                                maximumFractionDigits: 0, 
                              })  + "  " + item.currencySymbol + "  " + item.currencyFrom
                            )
                        }
                  {/* {item.fltPrice !== "Call for Price"
                    ? Number(item.fltPrice).toLocaleString(undefined, {
                        ...
                        <div class="diamond-information">
                          <ul class="diamond-spacification-list">
                            ...
                            <li>
                              ...
                              <div class="diamonds-info">
                                <p>{getSymmetry ? getSymmetry : "NA"}</p>
                              </div>
                            </li>
                            <li>
                              <div class="diamonds-details-title">
                            ...
                            <li>
                              ...
                              <div class="diamonds-info">
                                <p>{getCertificate ? getCertificate : "NA"}</p>
                              </div>
                            </li>
                            <li>
                              <div class="diamonds-details-title">
                              ...
                              <div class="diamonds-info">
                                <p>
                                  {getPrice === "Call for Price"
                                    ...
                                    : window.initData.data[0].price_row_format === '1'
                                    ? (item.currencyFrom === 'USD'
                                        ? window.currency + Number(getPrice).toLocaleString(undefined, {
                                          maximumFractionDigits: 0, 
                                        })
                                        : item.currencyFrom + "  " + item.currencySymbol + "  " + Number(getPrice).toLocaleString(undefined, {
                                          maximumFractionDigits: 0, 
                                        })
                                      )
                                    : (item.currencyFrom === 'USD'
