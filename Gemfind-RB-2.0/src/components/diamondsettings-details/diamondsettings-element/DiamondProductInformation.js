...
const DiamondProductInformation = (props) => {
  ...
  const handleSettings = (e) => {
    ...
    navigate("/apps/engagement-rings/settings");
  };
                      ...
                      <p>
                        {props.productDetailsData.fltPrice === "Call for Price"
                          ...
                          ? (props.productDetailsData.currencyFrom === 'USD'
                              ? window.currency + Number(props.productDetailsData.fltPrice).toLocaleString(undefined, {
                                maximumFractionDigits: 0, 
                              })
                              : props.productDetailsData.currencyFrom + "  " + props.productDetailsData.currencySymbol + "  " + Number(props.productDetailsData.fltPrice).toLocaleString(undefined, {
                                maximumFractionDigits: 0, 
                              })
                            )
                          : (props.productDetailsData.currencyFrom === 'USD'
                              ...
                              : Number(props.productDetailsData.fltPrice).toLocaleString(undefined, {
                                maximumFractionDigits: 0, 
                              })  + "  " + props.productDetailsData.currencySymbol + "  " + props.productDetailsData.currencyFrom
                            )
                        }
                        {/* {props.productDetailsData.fltPrice !== "Call for Price"
                          ? Number(
