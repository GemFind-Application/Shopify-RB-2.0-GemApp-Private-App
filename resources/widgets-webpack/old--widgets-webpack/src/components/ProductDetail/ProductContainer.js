...
const ProductContainer = () => {
    ...
    useEffect(() => {
        ...
        const getMetafieldsData = async () => {
            const res = await fetch(
                "https://gemfindapps.app.theringbuilder.com/api/getMetafields/" +
                    window.Shopify.shop +
                    "/" +
        ...
        const getInitTool = async () => {
            ...
            try {
                const res = await fetch(
                    "https://gemfindapps.app.theringbuilder.com/api/initToolApi",
                    requestOptions
                );
    ...
    const handledrophintSubmit = async (e) => {
        ...
        try {
            const res = await fetch(
                "https://gemfindapps.app.theringbuilder.com/api/dropHintApi",
                requestOptions1
            );
    ...
    const handleadddiamonds = (e) => {
        ...
        var redirect_url =
            "https://" +
            window.Shopify.shop +
            "/apps/engagement-rings/diamonds";
    ...
    const handlereginfoSubmit = async (e) => {
        ...
        try {
            const res = await fetch(
                "https://gemfindapps.app.theringbuilder.com/api/reqInfoApi",
                requestOptions2
            );
            const hintData = await res.json();
            setOpenThird(false);
    ...
    const handleemailfrndSubmit = async (e) => {
        ...
        try {
            const res = await fetch(
                "https://gemfindapps.app.theringbuilder.com/api/emailFriendApi",
                requestOptions3
            );
            const hintData = await res.json();
            setOpenFour(false);
    ...
    const handleschdSubmit = async (e) => {
        ...
        try {
            const res = await fetch(
                "https://gemfindapps.app.theringbuilder.com/api/scheViewApi",
                requestOptions4
            );
            const hintData = await res.json();
            setOpenFive(false);
